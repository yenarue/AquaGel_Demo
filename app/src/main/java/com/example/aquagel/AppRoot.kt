        ...
        Surface(modifier = Modifier.fillMaxSize()) {
            NavHost(
                ...
                composable(
                    ...
                    val photoUri = Uri.decode(
                        backStackEntry.arguments?.getString(Routes.Preview.ARG_PHOTO_URI).orEmpty()
                    )
                ...
                composable(
                    ...
                    val photoUri = Uri.decode(
                        backStackEntry.arguments?.getString(Routes.WoundForm.ARG_PHOTO_URI).orEmpty()
                    )
                    sharedViewModel.photoUri = photoUri
                    WoundInfoScreen(
                        photoUri = photoUri,
                ...
                composable(
                    ...
                    val photoUri = Uri.decode(
                        backStackEntry.arguments?.getString(Routes.Recommend.ARG_PHOTO_URI).orEmpty()
                    )
